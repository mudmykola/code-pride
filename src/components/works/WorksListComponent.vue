...
const works = computed(() => store.getters.allWorks);
</script>
...
>>>>>>> feature/CDP_footer
                ...
                <div class="works-list__text w-[40.313rem] flex flex-col justify-between px-[0.938rem]">
                    <h3 class="font-normal text-[1.75rem]">{{ item.number }}</h3>
